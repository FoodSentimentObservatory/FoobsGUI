...
public abstract class BaseRESTAPI {
   ...
   public BaseRESTAPI(Controller controller) {
	   System.out.println("calling connect to t");
      connectToTwitter( controller);
      createOrUpdateRemainingMap();
   }

   protected abstract void connectToTwitter(Controller controller);
